...
- `npm test` — Vitest, 123 unit tests under `src/**/*.test.ts`
...
- **DB schema**: fresh installs use `supabase/setup.sql`; `supabase/migrations/` is the incremental history for existing deployments (latest: 007 per-user URL index).
