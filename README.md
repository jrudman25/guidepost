...
- **SerpAPI compatibility** — Google Jobs listing-age filtering uses dynamic `uds` filters returned by SerpAPI instead of deprecated `chips` filters, and Google no-results responses are logged as warnings for easier diagnosis
